...
function updateTime () {
    ...
    $('.hour6').text(moment().add(2, 'h').format('hA')); // continuing to structure format of hours//
    $('.hour7').text(moment().add(3, 'h').format('hA')); // continuing to structure format of hours//
    $('.hour8').text(moment().add(4, 'h').format('hA')); // continuing to structure format of hours//
    $('.hour9').text(moment().add(5, 'h').format('hA')); // continuing to structure format of hours//
}
